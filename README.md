...
Description
----
The contact moment component offers the possibility to register/record contact moments around resources such as commonground resources. This functionality has deliberately been set up abstract. In essense a contact moment can be about anything from a request to a product or order or a combination of these. The only requirement is that the subject is identifiable by URL. Contact moments could have a relationship to the messaging service which generates contact moments when sending messages.
